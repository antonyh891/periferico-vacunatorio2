...
a persistence unit "periferico-vacunatorioPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/periferico_vac/periferico_vacunatorio/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "periferico-vacunatorio/pom.xml":
...
artifact ("periferico-vacunatorio.war") is already built. You can build
